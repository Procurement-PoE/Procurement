...
namespace POEApi.Model.Tests
{
    ...
    public class EssenceGeneratorTest
    {
        ...
        public void GenerateEssenceOrbTypes()
        {
            ...
            Assert.AreEqual(totalEssences, Currency.EssenceGenerator().Count);

            Currency.EssenceGenerator().ForEach(x => Debug.WriteLine(x));
        }
    }
}